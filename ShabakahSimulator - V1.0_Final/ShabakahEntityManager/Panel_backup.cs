...
namespace ShabakahEntityManager
{
    ...
    public class Panel
    {
        ...
        public Panel(string mac, bool isArmed, PanelType panelType)
        {
            MAC = mac;
            IsArmed = isArmed;
            PanelType = panelType;
        ...
        //Disarm - Response
        public static string DisarmResponse()
        {
        ...
        public static string GetInstallerCodeResponse()
        {
        ...
        public static string IsPassCodeValidResponse()
        {
            string response = "";
            switch (PanelType)
            {
        ...
        //Arm - Response
        public static string ArmResponse()
        {
        ...
        //Bypass - Response
        public static string BypassResponse()
        {
